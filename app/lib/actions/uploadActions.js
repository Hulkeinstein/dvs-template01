...
export async function uploadLessonAttachment(base64Data, fileName) {
  ...
  try {
    ...
    if (!base64Data || !fileName) {
      throw new Error('Missing required parameters: base64Data and fileName are required');
    }
    ...
    if (base64Size > maxSize) {
      throw new Error(`File size exceeds ${maxSize / 1024 / 1024}MB limit. Current size: ${(base64Size / 1024 / 1024).toFixed(2)}MB`);
    }
