...
export const getVerificationPromptMessage = (feature: string): string => {
  const messages: Record<ProtectedFeature, string> = {
    ...
    publish_course:
      'To publish your course, please verify your phone number for security purposes.',
    payment:
      'Phone verification is required for payment processing to ensure account security.',
    withdrawal:
      'For your security, phone verification is required before making withdrawals.',
    certificate_generation:
      'Phone verification ensures the authenticity of certificates issued.',
    bulk_notifications:
      'Verify your phone to send bulk notifications to your students.',
  };
