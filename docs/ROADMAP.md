...
2026-01-23 이후 멈췄던 프로젝트를 다시 점검한 결과입니다. 아래 Phase 0~3의 일정(2025-11 ~ 2026-01)은 모두 지났습니다. [ADR 0003](./adr/0003-continue-existing-codebase.md)에 따라 **현 코드베이스를 정리하며 지속**하고, 기존 Phase 일정은 아래 T1~T6을 마친 뒤 다시 잡습니다.
...
| T1. 저장소 위생·CI 복구 (줄바꿈 정규화, 추적 산출물, 서식, Next 14.2.35 패치, 완료된 work-plan 2개 삭제) | 🔜 다음 작업 | 선행 없음 · [work plan](./work-plans/repo-hygiene-ci.md) |
| T2. HiStudy 데모 페이지·컴포넌트 삭제 | 📋 계획됨 | 선행 T1 · 보류된 `work-plans/histudy-demo-cleanup.md` 재사용 |
