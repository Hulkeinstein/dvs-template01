...
describe('CourseRepository', () => {
  ...
  describe('bulk operations', () => {
    it('should handle bulk create and filtering', async () => {
      // Given: 여러 코스 한번에 생성
      const courses = [
        { title: 'Course 1', instructor_id: 'inst-1', price: 10, is_published: true },
        { title: 'Course 2', instructor_id: 'inst-1', price: 20, is_published: false },
        { title: 'Course 3', instructor_id: 'inst-2', price: 30, is_published: true },
        { title: 'Course 4', instructor_id: 'inst-2', price: 40, is_published: true },
      ].map(c => ({
        ...c,
