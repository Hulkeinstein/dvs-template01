          ...
          <div className="row row-15">
            ...
            <div className="col-lg-12">
              <div className="course-field mb--15">
                ...
                ></textarea>
                <small className="d-block mt_dec--5">
                  <i className="feather-info"></i> Maximum of 15 keywords
                  covering features, usage, and styling. Keywords should all be
                  in lowercase and separated by commas. e.g. photography,
