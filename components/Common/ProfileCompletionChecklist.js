      ...
      const items = [
        ...
        },
        {
          ...
          completed:
            ...
            userProfile.photo_url !== '/images/team/avatar.jpg',
          required: false,
          link: '#',
          icon: 'feather-camera',
        },
        ...
        <div className="row">
          <div className="col-lg-12">
            ...
            <div className="rbt-profile-completion-wrapper">
              <div
                className="rbt-progress-style-1"
                style={{ marginBottom: isCollapsed ? '10px' : '20px' }}
              >
                ...
                {incompleteCount > 0 && isCollapsed && (
                  <p className="text-muted mt-2 mb-0">
                    {incompleteCount} {incompleteCount === 1 ? 'item' : 'items'}{' '}
                    remaining
                  </p>
                )}
              </div>
              ...
              <div
                ...
                style={{ marginBottom: isCollapsed ? '0' : '20px' }}
              >
                <button
                ...
                >
                  ...
                  <i
                    className={`feather ms-2 ${isCollapsed ? 'feather-chevron-down' : 'feather-chevron-up'}`}
                  ></i>
                </button>
              </div>
                ...
                {checklist.map((item) => (
                  <div key={item.id} className="rbt-checklist-item">
                    <div className="d-flex align-items-center">
                      <div
                        className={`rbt-checkbox ${item.completed ? 'checked' : ''}`}
                      >
                        {item.completed ? (
                      ...
                      <div className="ms-3">
                        ...
                        {item.badge && (
                          <span
                            className={`badge ms-2 ${item.completed ? 'bg-success' : 'bg-warning'}`}
                          >
                            {item.badge}
                          </span>
                        )}
                  ...
                  <div className="alert alert-info mt--30" role="alert">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        ...
                        <p className="mb-0">
                          Phone verification enhances account security and
                          enables features like SMS notifications for important
