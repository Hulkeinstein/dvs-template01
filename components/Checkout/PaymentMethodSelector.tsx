...
const paymentMethods: PaymentMethod[] = [
  {
    ...
    description:
      'Pay securely with your credit or debit card through Stripe. Your payment information is encrypted and secure.',
  ...
  },
  {
    ...
    label: 'PayPal',
    description:
      'Pay with your PayPal account. You will be redirected to PayPal to complete your payment securely.',
  ...
  },
  {
    ...
    label: 'Pay Later',
    description:
      'Reserve your course now and pay later. Your enrollment will be confirmed, and you can access the course after payment is completed.',
    icon: 'feather-clock',
  },
];
...
const PaymentMethodSelector: React.FC<PaymentMethodSelectorProps> = ({
  ...
  // Filter payment methods based on showPayLater flag only
  ...
  return (
    ...
    >
      {displayMethods.map((method, index) => {
        // Disable Stripe if not enabled
        const isDisabled = method.value === 'stripe' && !isStripeEnabled;
        ...
        return (
          <div key={method.id} className="single-method">
            ...
            >
              ...
              {method.label}
              {isDisabled && (
                <span className="text-muted ms-2">(Coming Soon)</span>
              )}
            </label>
            <div
            ...
            >
              <div className="accordion-body">{method.description}</div>
            </div>
          </div>
        );
      })}
